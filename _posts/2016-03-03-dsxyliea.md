...
Un'amica che soffre di dislessia mi ha descritto la sua esperienza quando legge. *Riesce* a leggere, ma le occorre un sacco di concentrazione, e le lettere sembra che "saltino in qua e in là"

Ricordo di aver letto della [typoglycemia](https://en.wikipedia.org/wiki/Typoglycemia). Non sarebbe stato possibile farlo in modo interattivo in un sito web usando Javascript? Certamente.

Vi va di creare un boomarklet di questa pagina o qualcosa di simile? [Fate un fork](https://github.com/geon/geon.github.com/blob/master/_posts/2016-03-03-dsxyliea.md) su github.
